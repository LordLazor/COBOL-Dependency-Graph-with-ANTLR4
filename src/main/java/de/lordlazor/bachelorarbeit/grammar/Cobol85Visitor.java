...
public interface Cobol85Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Cobol85Parser#copyStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCopyStatement(Cobol85Parser.CopyStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link Cobol85Parser#procedureCopyStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProcedureCopyStatement(Cobol85Parser.ProcedureCopyStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link Cobol85Parser#copySource}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCopySource(Cobol85Parser.CopySourceContext ctx);
	/**
	 * Visit a parse tree produced by {@link Cobol85Parser#copyLibrary}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCopyLibrary(Cobol85Parser.CopyLibraryContext ctx);
	/**
